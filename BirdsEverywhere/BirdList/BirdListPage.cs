...
{
    internal class BirdListPage : IClickableMenu
    {
        ...
        private readonly Dictionary<string, BirdData> Birds = new();
        ...
        private void DrawNpcSlot(SpriteBatch b, int i)
        {
            ...
            string birdID = this.Names[i];
            var bird = this.Birds[birdID];
            string name = bird.name;
            string observedLocation = this.Observations[birdID].observationLocation;
            ...
            // location
            b.DrawString(Game1.dialogueFont, observedLocation, new Vector2(this.xPositionOnScreen + 250 + 264, this.Sprites[i].bounds.Y + 32 - 12), Game1.textColor);
        }
